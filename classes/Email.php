...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido .= "<p>Presiona aquí: <a href='http://{$dominio}/confirmar-cuenta?token=". $this->token ."'>Confirmar Cuenta</a> </p>";
    ...
    public function enviarInstrucciones() {
        ...
        $contenido .= "<p>Presiona aquí: <a href='http://{$dominio}/recuperar?token=". $this->token ."'>Confirmar Cuenta</a> </p>";
